...
{
    public partial class order_getOrdersInfo : System.Web.UI.Page
    {
        /// <summary>
        /// API基本资料
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strResult = "";
            string strMethod = "/rsService/order/getOrdersInfo";//API方法
            string postData = "referenceNumber=EXT5460650532959126053";   //请求数据
