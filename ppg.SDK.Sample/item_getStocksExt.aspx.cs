...
{
    public partial class item_getStocksExt : System.Web.UI.Page
    {
        /// <summary>
        /// API基本资料
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strResult = "";
            string strMethod = "/rsService/item/getStocksExt";//API方法
            string postData = "datas.sku=1111&datas.sku=0000&datas.sku=222";   //请求数据
