...
{
    public partial class order_getTrackingNumber : System.Web.UI.Page
    {
        /// <summary>
        /// API基本资料
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strResult = "";
            string strMethod = "/rsService/order/getTrackingNumber";//API方法
            string postData = "orderNumber=5491850734555033528&referenceNumber=";   //请求数据
